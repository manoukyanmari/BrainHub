 ...
 */
class BrainHubDocumentUserHydrator implements HydratorInterface
{
    private $dm;
    private $unitOfWork;
    private $class;
    ...
    public function hydrate($document, $data, array $hints = array())
    {
        ...
        if (isset($data['authToken'])) {
            ...
            $return = (string) $value;
            $this->class->reflFields['authToken']->setValue($document, $return);
            $hydratedData['authToken'] = $return;
        }
        ...
        if (isset($data['isGod'])) {
            $value = $data['isGod'];
            $return = (bool) $value;
            $this->class->reflFields['isGod']->setValue($document, $return);
            $hydratedData['isGod'] = $return;
        }
        return $hydratedData;
    }
}